...
- **Dify push**: `scripts/upload_papers.sh` → Dify v1 API → 82/84 documents updated. 2 PDFs (Höfer 2023, Schaffrath 2025) sind nicht im Dataset – reines Upload-Gap, kein Metadata-Gap. Metadaten für alle 84 liegen in `reports/metadata_dump_32b.json` vor.
