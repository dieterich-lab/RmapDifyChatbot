...
def main(doc_id=None, item_title=None, item_authors=None, item_year=None, item_journal=None, paper_count=None):
    api_base = (
    ...
    api_key = (
        _norm(os.getenv('DIFY_API_KEY')) or 'dataset-z3bHkQ6eUPKN21GaLq3KXIiS'
    )
    ...
    meta_line = f'{title} ({year}, {journal}) — {authors}' if (year or journal or authors) else title
    header = f'=== {meta_line} ==='
