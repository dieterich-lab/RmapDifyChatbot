...
def main(**kwargs):
    ...
    # ── EU AI Act Article 50(2): AI-generated content watermark ──
    # Human-readable disclaimer + machine-readable HTML comment.
    # The HTML comment survives Markdown rendering and is detectable
    # in raw API payloads, fulfilling the "machine-readable format"
    # requirement until the EU Code of Practice defines a standard.
    if merged:
        merged += (
            "\n\n---\n"
            "*Disclaimer (EU AI Act Art. 50): "
            "This text was synthetically generated by an AI system "
            "(RMaP Copilot via Dify/Ollama/vLLM). "
            "Please verify against cited sources.* "
